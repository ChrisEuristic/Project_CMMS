        ...
        React.createElement("form", { action: "http://1.254.141.230:8086/join", method: "post", target: 'hidden_iframe' },
            ...
            React.createElement("div", { className: 'type' },
                React.createElement("div", { className: 'inline-flex' },
                    React.createElement("input", { type: "radio", name: "type", value: "\uAC1C\uBC1C\uC790", onClick: () => { chooseType('개발자'); } }),
                    "\uAC1C\uBC1C\uC790\u00A0",
                    React.createElement("input", { type: "radio", name: "type", value: "\uC0AC\uC5C5\uC790", onClick: () => { chooseType('사업자'); } }),
                    "\uC0AC\uC5C5\uC790"),
                React.createElement("div", { className: 'inline-flex' },
                    React.createElement("input", { type: "radio", name: "type", value: "\uC791\uC5C5\uC790", onClick: () => { chooseType('작업자'); } }),
                    "\uC791\uC5C5\uC790\u00A0",
                    React.createElement("input", { type: "radio", name: "type", value: "\uAE30\uC220\uC790", onClick: () => { chooseType('기술자'); } }),
                    "\uAE30\uC220\uC790")),
